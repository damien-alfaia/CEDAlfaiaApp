...
namespace CEDAlfaiaAppV2.Models
{
    ...
    public class ParametrageModel
    {
        ...
        public ParametrageModel(Parametrage pParametrage)
        {
            if (pParametrage != null)
            {
                ...
                this.TVAIntraCommunautaire = pParametrage.TVAIntraCommunautaire;
                this.ObjectifAnnuel = pParametrage.ObjectifAnnuel;
            }
        }
    }
    ...
    public class KeyValue
    {
        ...
        public KeyValue(int pKey, string pValue)
        {
            this.Key = pKey;
            this.Value = pValue;
        }
